 ...
 */
@Data
public class EelinkAlarmResponse {
    
    /** 帧代号 */
    private static final byte FRAME_CODE = 0x42;
    ...
    public static final byte ERROR_DATA_INVALID = 0x02;    // 数据错误
     ...
     * 创建成功响应
     */
    public static EelinkAlarmResponse success(byte[] address) {
        EelinkAlarmResponse response = new EelinkAlarmResponse();
     ...
     * 创建错误响应
     */
    public static EelinkAlarmResponse error(byte[] address, byte errorCode) {
        EelinkAlarmResponse response = new EelinkAlarmResponse();
        response.address = address;
